---
description: La propiedad fields es una estructura utilizada para relacionar productos o artículos en el proceso. Puede contener varios objetos NameValuePair que representan diferentes datos a anexar en el proceso.
---
# Campos Adicionales
